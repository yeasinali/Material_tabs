package com.food.recipe.simple_tab;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button btnSimpleTabs, btnScrollableTabs, btnIconTextTabs, btnIconTabs, btnCustomTabs;
...
//        setSupportActionBar(toolbar);
        ...
        btnCustomTabs = (Button) findViewById(R.id.btnCustomTabs);
        ...
        btnCustomTabs.setOnClickListener(this);
